document.addEventListener("DOMContentLoaded", async function () {
    ...
    connectWalletBtn.addEventListener('click', async () => {
        try {
            ...
            const signingAccount = AccountId.fromString(process.env.MY_ACCOUNT_ID);
            const savedData = await hashconnect.connectToLocalWallet();
            const pairings = savedData.pairingData;
